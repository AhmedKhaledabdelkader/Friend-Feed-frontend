...
@Component({
  selector: 'app-showfriendsonly',
  templateUrl: './showfriendsonly.component.html',
  styleUrls: ['./showfriendsonly.component.css']
})
export class ShowfriendsonlyComponent {
  ...
  getPosts(): void {
    this.post.getFriendsPosts().subscribe({
      next: (response) => {
